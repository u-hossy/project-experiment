    ...
    <div className="w-full min-w-80 max-w-3xl p-4 pt-60">
      ...
      <Card className={cn("mb-8 flex w-full scroll-mt-20 flex-col shadow-md")}>
        ...
        <CardContent className="flex flex-col">
          ...
          <Card className={cn("mb-8 flex w-full scroll-mt-20 flex-col shadow-md bg-gray-100")}>
            <CardHeader className="font-bold text-2xl tracking-wide"><div className="flex h-16 w-full items-center px-4">
              <img
                src="/lightbulb.svg"
                alt="BookOpenアイコン"
